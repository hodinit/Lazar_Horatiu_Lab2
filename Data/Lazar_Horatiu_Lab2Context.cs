...
namespace Lazar_Horatiu_Lab2.Data
{
    public class Lazar_Horatiu_Lab2Context : DbContext
    {
        ...
        public DbSet<Lazar_Horatiu_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Lazar_Horatiu_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Lazar_Horatiu_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
